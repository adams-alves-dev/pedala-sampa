/* proto-icons.js — Pedala Sampa line-icon set.
   1.75px stroke, 24x24, currentColor, round caps — matches the signage aesthetic.
   PS.icon(name, {size, cls, stroke}) -> inline SVG string. */
(function () {
  const P = {
  ...
  window.PS.ICONS = P;
  // badge key -> icon name
  window.PS.BADGE_ICON = { 'Dia': 'calendar', 'Saída': 'clock', 'Nível': 'gauge', 'Distância': 'route', 'Dist.': 'route', 'Ritmo': 'speed', 'Volta média': 'compass' };
})();
