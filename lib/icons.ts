...
export const ICON_PATHS = {
  ...
  gauge:
    '<path d="M4 19a8 8 0 1 1 16 0"/><path d="M12 19l4.5-6"/><circle cx="12" cy="19" r="1.2" fill="currentColor" stroke="none"/>',
  route:
    '<circle cx="5.5" cy="18.5" r="2.4"/><circle cx="18.5" cy="5.5" r="2.4"/><path d="M8 18.5h6a3.5 3.5 0 0 0 0-7H10a3.5 3.5 0 0 1 0-7h6"/>',
  ...
  pencil:
    '<path d="M14.5 5.5l4 4M4 20l1-4.5L16 4.5a2 2 0 0 1 3 3L8 18.5 4 20Z"/>',
  ...
  users:
    '<circle cx="9" cy="8.5" r="3"/><path d="M3.5 19a5.5 5.5 0 0 1 11 0"/><path d="M16 6.2a3 3 0 0 1 0 5.6M16.5 14.2A5.5 5.5 0 0 1 20.5 19.5"/>',
